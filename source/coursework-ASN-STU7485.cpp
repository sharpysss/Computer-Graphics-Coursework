...
int main(void)
{
    ...
    GLFWwindow* window;
    window = glfwCreateWindow(1024, 768, "Assignment", NULL, NULL);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glm::mat4 lightModel = Maths::translate(lightPosition) * Maths::scale(glm::vec3(0.1f));
        glm::mat4 lightMV = camera.view * lightModel;
        glm::mat4 lightMVP = camera.projection * lightMV;

        glUniformMatrix4fv(glGetUniformLocation(lightShaderID, "MVP"), 1, GL_FALSE, &lightMVP[0][0]);
        glUniformMatrix4fv(glGetUniformLocation(lightShaderID, "MV"), 1, GL_FALSE, &lightMV[0][0]);
